CREATE TABLE tabela_de_produtos (CODIGO_DO_PRODUTO varchar(50),
NOME_DO_PRODUTO varchar(100),SABOR varchar(50),TAMANHO varchar(50),EMBALAGEM varchar(20),PRECO_DE_LISTA decimal(4,2)) ;
